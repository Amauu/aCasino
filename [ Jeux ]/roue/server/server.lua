            ...
            if xPlayer.getMoney() >= amount then
                ...
                SetTimeout(12000, function()
                    ...
                    if _priceIndex == 1 or _priceIndex == 9 or _priceIndex == 13 or _priceIndex == 17 then
                        ...
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^8Rotation: ^1'.. xPlayer.name .. " a gagné 1 chapeau 1, armure 1 !")
                    elseif _priceIndex == 2 or _priceIndex == 6 or _priceIndex == 10 or _priceIndex == 14 or _priceIndex == 18 then
                        ...
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^88Rotation: ^1'.. xPlayer.name .. " a gagné 24 bouteilles d'eau minérale + 10 pains!")
                    elseif _priceIndex == 3 or _priceIndex == 7 or _priceIndex == 15 or _priceIndex == 20 then
                        ...
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^88Rotation: ^1'.. xPlayer.name .. " a gagné " .. ESX.Math.GroupDigits(_money) .. "$")
                    elseif _priceIndex == 4 or _priceIndex == 8 or _priceIndex == 11 or _priceIndex == 16 then
                        ...
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^88Rotation: ^1'.. xPlayer.name .. " a gagné " .. ESX.Math.GroupDigits(_blackMoney * 10) .. "$")
                    elseif _priceIndex == 5 then
                        -- print("Win 300,000$")
                        xPlayer.addMoney(300000)
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^88Rotation: ^1'.. xPlayer.name .. " a remporté le prix de 300 000 $!")
                    elseif _priceIndex == 12 then
                        -- print("Win ak gold")
                        xPlayer.addInventoryItem("attach_skin_ak", 1)
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^88Rotation: ^1'.. xPlayer.name .. " a gagné 1 Skin AK Gold!")
                    elseif _priceIndex == 19 then
                        -- print("Win car lp700r")
                        TriggerClientEvent("esx_tpnrp_luckywheel:winCar", _source)
                        TriggerClientEvent('chatMessage', -1, '', {255,255,255}, '^88Rotation: ^1'.. xPlayer.name .. " a gagné 1 Voiture!")
                    end
                ...
                TriggerClientEvent("esx_tpnrp_luckywheel:rollFinished", -1)    
                TriggerClientEvent('esx:showNotification', _source, "Vous n'avez pas assez d'argent dans votre portefeuille pour jouer! Demande " .. ESX.Math.GroupDigits(amount) .. "$ pour 1 tour!")
            end
        end
    end
end)
