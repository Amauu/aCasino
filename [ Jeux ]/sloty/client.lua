...
RegisterNUICallback('wygrana', function(data)
	TriggerEvent('pNotify:SendNotification', {text = 'Tu as gagnez '..data.win..' jetons!'})
end)
...
Citizen.CreateThread(function()
	while true do
		...
		for i=1, #Config.Sloty do
			...
			if dis <= 2.0 then
				ESX.ShowHelpNotification('Appuie sur ~INPUT_PICKUP~ jouer aux machines à sous.')
		...
		for i=1, #Config.Ruletka do
			...
			if dis <= 2.0 then
				ESX.ShowHelpNotification('Appuie sur ~INPUT_PICKUP~ jouer à la roulette.')
