...
RageUI.Settings = {
    ...
    Items = {
        ...
        Background = { Dictionary = "casino", Texture = "gradient_bgd", Y = 0, Width = 431 },
        Navigation = {
            Rectangle = { Width = 431, Height = 18 },
            Offset = 5,
            Arrows = { Dictionary = "casino", Texture = "shop_arrows_upanddown", X = 190, Y = -6, Width = 50, Height = 50 },
        },
        Description = {
            Bar = { Y = 4, Width = 431, Height = 4 },
            Background = { Dictionary = "casino", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 30 },
            Text = { X = 8, Y = 10, Scale = 0.35 },
        },
    },
    Panels = {
        Grid = {
            Background = { Dictionary = "casino", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 275 },
        ...
        Percentage = {
            Background = { Dictionary = "casino", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 76 },
