---@type table
local Colour = {
    Background = { Dictionary = "italien", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 112 },
    LeftArrow = { Dictionary = "italien", Texture = "arrowleft", X = 7.5, Y = 15, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "italien", Texture = "arrowright", X = 393.5, Y = 15, Width = 30, Height = 30 },
